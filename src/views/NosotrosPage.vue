      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
          <div class="flex-1">
            ...
            <p class="text-xl text-sky-100 max-w-2xl">Somos una entidad paraestatal comprometida con el desarrollo y bienestar de México.</p>
          </div>
          <div class="flex-shrink-0">
            <img src="https://grupomundomaya.com/assets/img/Botones/Unimos el cielo y la tierra eslogan.png" alt="Unimos el cielo y la tierra" class="h-20 md:h-24" />
          </div>
        </div>
      </div>
    </section>
